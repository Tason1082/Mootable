...
class PostsGridPage extends StatefulWidget {
  final String title;
  final Future<List<Map<String, dynamic>>> Function(int limit, int offset) fetcher;
  ...
  @override
  State<PostsGridPage> createState() => _PostsGridPageState();
}

class _PostsGridPageState extends State<PostsGridPage> {
  ...
  Future<void> fetchPosts({bool loadMore = false}) async {
    ...
    try {
      final newPosts = await widget.fetcher(limit, offset);
